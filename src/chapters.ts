...
enum SkillsEnum {
    rc = "react", ng = "ng", bs = "bs", cs = "cs", net = "net", netframework = "netframework",
    ts = "ts", ef = "efcore", sql = "sql", pg = "pg", cos = "cos", firebase = "firebase",
    gcloud = "gcloud", az = "az", aws = "aws", servicebus = "servicebus", iothub = "iothub",
    nodejs = "nodejs", jq = "jq",
}
